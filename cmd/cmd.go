...
import (
	...
	"github.com/gnehs/tcardgen/pkg/canvas"
	"github.com/gnehs/tcardgen/pkg/canvas/fontfamily"
	"github.com/gnehs/tcardgen/pkg/config"
	"github.com/gnehs/tcardgen/pkg/hugo"
)
...
func generateTCard(contentPath, outPath string, tpl image.Image, ffa *fontfamily.FontFamily, cnf *config.DrawingConfig) error {
	...
	if err := c.DrawTextAtPoint(
		fmt.Sprintf("%s", fm.Date.Format("2006 年 01 月 02 日")),
		*cnf.Info.Start,
